...
rem $Id: makefile.bat,v 1.7 2008/01/23 13:39:00 rbowler Exp $
...
rem Revision 1.7  2008/01/23 13:39:00  rbowler
rem Modifications for VS9 C++ 2008 Express by Charlie Brint
rem
