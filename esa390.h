/* ESA390.H	(c) Copyright Roger Bowler, 1994-1999		     */
/*		ESA/390 Data Areas				     */
...
typedef unsigned char		FWORD[4];
typedef unsigned char		DWORD[8];
...
/*0A8*/ DWORD resv0A8;			/* Reserved		     */
/*0B0*/ DWORD resv0B0;			/* Reserved		     */
